        ...
        <div>
            ...
            >
                ...
                {show?(<Alert variant="danger" onClose={() => setShow(false)} dismissible>
                    <Alert.Heading className='m-0 ' >Nomor Registrasi Sudah Ada!</Alert.Heading>
                    <p className='m-0 '>
                        Silahkan Masukkan Nomor Registrasi yang Lain!
                    </p>
                </Alert>):(
                    <></>
                )}
                ...
                <div className='d-flex justify-content-start gap-3 mb-3 '>
                    {isLoading ?
                        (<button className='btn bg-primary fw-bold' >Loading...</button>) :
